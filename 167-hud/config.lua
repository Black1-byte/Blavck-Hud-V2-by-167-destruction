...
Config.WaterMarkLogo = "none" -- Logo url
Config.LogoWidth = "256px"
Config.LogoHeight = "256px"
...
-------------------------------------------- Keys --------------------------------------------
Config.DefaultCruiseControlKey = "LMENU" -- Default control key for cruise. Players can change the key according to their desire 
...
Config.Notifications = { -- Notifications
    ...
    ["no_veh_nearby"] = {
        type = "error",
        message = "Non cè nessun veicolo vicino.",
        time = 5000
    }, 
    ["cash_display"] = {
        type = "check",
...
Config.Notification = function(message, type, isServer, src) -- You can change here events for notifications
    if isServer then
        if Config.Framework == "esx" then
            TriggerClientEvent('esx:showNotification', src, message, nil, type)
        else

...
if Config.EnableNitro then
    ...
    RegisterNetEvent('blvckhudv2:SetupNitro')
    AddEventHandler('blvckhudv2:SetupNitro', function()
        ...
        if IsPedSittingInAnyVehicle(playerPed) then
            ...
            if vehicle ~= nil and DoesEntityExist(vehicle) and IsPedOnFoot(playerPed) then
                ...
                Citizen.CreateThread(function()
                    ...
                    TriggerServerEvent('blvckhudv2:RemoveItem',Config.NitroItem, 1)
                    TriggerServerEvent('blvckhudv2:InstallNitro', GetVehicleNumberPlateText(vehicle))
                end)
            else
    ...
    RegisterNetEvent('blvckhudv2:UpdateNitroData')
    AddEventHandler('blvckhudv2:UpdateNitroData', function(nitroData)
        nitro = nitroData
                ...
                if GetPedInVehicleSeat(playerVeh, -1) == playerPed then
                    while isPressing do
                        ...
                        if tonumber(nitro[GetVehicleNumberPlateText(playerVeh)]) <= 0 then
                            ...
                            TriggerServerEvent('blvckhudv2:UpdateNitro', GetVehicleNumberPlateText(playerVeh), nitro[GetVehicleNumberPlateText(playerVeh)])
                            break
